...
public class wancheng extends Activity{
	private static int Uid;
	private static  String processURL="http://172.16.146.94:8080/Mercenary/findrewardbyid?reward.rid=";
	private static  String processURL1="http://172.16.146.94:8080/Mercenary/finishtask?task.Tid=";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			TextView xuanshang_name1 = (TextView) findViewById(R.id.reward_name1);
			TextView xuanshang_level1 = (TextView) findViewById(R.id.reward_lavel);
			TextView xuanshang_money1 = (TextView) findViewById(R.id.reward_money1);
			TextView xuanshang_time1 = (TextView) findViewById(R.id.reward_money1);
			TextView xuanshang_time2 = (TextView) findViewById(R.id.reward_time2);
			TextView xuanshang_text1 = (TextView) findViewById(R.id.reward_text);
	...
	public void finish(View v) throws ClientProtocolException, IOException, JSONException{
	...
	public void fabuService() throws ClientProtocolException, IOException, JSONException {
		...
		if (json != null) {
			...
			if (!result1.equals(null)) {
				...
				intent.setClass(wancheng.this, mainXuanshang.class);
...
//				System.out.println(id);
	...
	public void login_back2(View v) {
		Intent intent = new Intent();
		intent.setClass(wancheng.this, mainXuanshang.class);
		Bundle bundle =new Bundle();
		bundle.putInt("id", Uid);
